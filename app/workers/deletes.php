...
class DeletesV1
{
            ...
            case DELETE_TYPE_DOCUMENT:
                ...
                switch (strval($document->getCollection())) {
                    ...
                    case Database::COLLECTION_USERS:
                        ...
                        break;
                    case Database::COLLECTION_COLLECTIONS:
    ...
    protected function deleteDocuments(Document $document, $projectId) 
    {
        ...
        $this->deleteByGroup($document->getId(), [], $this->getProjectDB($projectId));   
    }
    ...
    protected function deleteExecutionLogs() 
    {
        $this->deleteForProjectIds(function($projectId) {
            ...
            // Delete Executions
            $this->deleteByGroup(Database::COLLECTION_EXECUTIONS, [], $projectDB);
        });
    }
    ...
    protected function deleteForProjectIds(callable $callback)
    {
        ...
        while($sum === $limit) {
            ...
            Authorization::disable();
            $projects = $this->getConsoleDB()->find(Database::COLLECTION_PROJECTS, [
                'limit' => $limit,
                'offset' => $count,
                'orderType' => 'ASC',
                'orderCast' => 'string',
